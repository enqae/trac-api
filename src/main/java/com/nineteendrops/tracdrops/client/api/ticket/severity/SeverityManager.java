package com.nineteendrops.tracdrops.client.api.ticket.severity;
 ...
 */
// TODO: same thing as in ResolutionManager
@TracClass(tracClass = "ticket.severity")
public interface SeverityManager {

    @TracClassMethod(tracClassMethodName = "getAll",
                     returnDecoder = ArrayToStringArrayListDecoder.class)
    public ArrayList getSeverities() throws TracMethodExecutionException;

    @TracClassMethod(tracClassMethodName = "get")
    public String getSeverityOrder(String severityName) throws TracMethodExecutionException;

    @TracClassMethod(tracClassMethodName = "delete")
    public Integer delete(String severityName) throws TracMethodExecutionException;
    ...
    public Integer create(@TracParameterEncoder(encoder = SimpleObjectToCreateUpdateFormatEncoder.class)
                          Severity severity) throws TracMethodExecutionException;
